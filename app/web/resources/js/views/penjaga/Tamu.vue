    ...
    <main class="bg-gray-50 dark:bg-gray-900 h-screen">
        <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
            <div class="flex flex-col w-full max-w-xl p-6 space-y-8 items-center justify-center mb-8  rounded-lg shadow-xl  lg:mb-10 dark:text-white">
                <div class="space-y-6"><h1 class="p-5 font-bold text-2xl"> HALAMAN TAMU </h1></div>
            </div>
            <!-- Card -->
            <div class="w-full max-w-xl p-6 h-full space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                <div class="relative overflow-x-auto">
                    <div class="space-y-6 text-center">
                        <h1 class="p-5 font-bold text-2xl"> List History Tamu Perumahan </h1>
                    </div>
                                ...
                                <div class="overflow-hidden shadow">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">Tujuan Tamu Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur, eum.</td>
                                            <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                    <div class="text-base font-semibold text-gray-900 dark:text-white">N 2222 ABCD</div>
                                                </div>
                                            </td>
